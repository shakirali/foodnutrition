...
- **Local Store Search**: Find specific products at nearby grocery stores and supermarkets (Google Search integration)
...
2. **Dietary Analysis & RDI** ✅: Analyzes intake against Recommended Daily Intake (integrated in main agent)
3. **Recommendation Engine** ✅: Suggests specific branded products to fill nutritional gaps
4. **Comparison Agent** (Planned): Compares dishes nutritionally
5. **Local Store Search Tool** ✅: Finds specific products at grocery stores (Tesco, Waitrose, etc.)
...
| `GOOGLE_API_KEY` | Google API key for local store search | - | Recommended |
| `GOOGLE_SEARCH_ENGINE_ID` | Google Search Engine ID | - | Recommended |

*Required for finding specific products and local stores
